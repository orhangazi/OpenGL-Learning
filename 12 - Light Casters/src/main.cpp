...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// this is usually the same as the surface 's color. The diffuse material vector defines the
		// color of the surface under diffuse lighting. The diffuse color is (just like ambient lighting)
		// set to the desired surface' s color.The specular material vector sets the color of the specular
		...
		// choosing colors that range from white to gray to black, not affecting the actual colors of
		// the object(only its intensity).Since we now have easy access to the light 's properties we
