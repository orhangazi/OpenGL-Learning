...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		// Directional Light (Yönlü Işık. Güneş ışığı gibi)
		lightingShader.setVec3("dirLight.ambient", 0.05f, 0.05f, 0.05f);
		lightingShader.setVec3("dirLight.direction", -0.2f, -1.0f, -0.3f);
		lightingShader.setVec3("dirLight.diffuse", 0.4f, 0.4f, 0.4f);
		lightingShader.setVec3("dirLight.specular", 0.5f, 0.5f, 0.5f);

		// Point light 1 (Nokta ışığı. Mum, sokak lambası gibi):
		...
		// Point light 2 (Nokta ışığı. Mum, sokak lambası gibi):
		...
		// Point light 3 (Nokta ışığı. Mum, sokak lambası gibi):
		...
		// Point light 4 (Nokta ışığı. Mum, sokak lambası gibi):
